use iced_winit::{winit, program, Program, Size};
...
impl ViewportDesc {
   ...
   pub fn build<P: 'static + Program>(self, _adapter: &wgpu::Adapter, device: &wgpu::Device, state: program::State<P>) -> WindowViewport<P> {

...
use iced_winit::{conversion, futures, program, winit, Debug, Clipboard, Application};
use winit::{
                ...
                match event {
                        ...
                        match event {
                            ...
                            WindowEvent::MouseInput {
                                ...
                                MouseButton::Right => {
                                    ...
                                    context_menu = Some((context_menu_window_state, context_menu_program_state));
                                },
                                _ => context_menu = None
                            }
                            _ => {}
                    ...
                    Event::RedrawRequested(_) => {
                        if let Some((win_state, prog_state)) = &mut context_menu {
                            ...
                            match desktop_window_state.render(desktop_program_state.primitive(), &debug.overlay()) {
                                Ok(()) => {},
                                Err(wgpu::SwapChainError::Lost) => {
